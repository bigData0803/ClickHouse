    ...
    : name(name_)
{
    ...
    virtual_columns = {
        ColumnWithTypeAndName(std::make_shared<DataTypeDateTime>(), "metadata_modification_time"),
        ColumnWithTypeAndName(std::make_shared<DataTypeString>(), "query_create_table"),
        ColumnWithTypeAndName(std::make_shared<DataTypeString>(), "engine_full")
    };
}
